...
• English → the source material incorrectly stated that X
• Swedish → källmaterialet påstod felaktigt att X
• German → Im Quellmaterial wurde fälschlicherweise angegeben, dass X
• Spanish → la fuente indicaba incorrectamente que X
• French → la source indiquait par erreur que X
...
`Det antal runtecken som det urnordiska alfabetet Futhark består av är {{c1::24}}.[TAB]Futhark är det äldsta kända runalfabetet och användes i Skandinavien och norra Europa från ca 200 e.Kr.[TAB][TAB]CORRECTED: källmaterialet påstod felaktigt att Futhark har 16 runor`
