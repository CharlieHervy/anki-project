...
Leverera endast rådata i korrekt leveransformat. Ingen hälsning, inget eftersnack, inga introduktioner. Varje tecken som inte tillhör en giltig rad i outputen underkänner genereringen.
